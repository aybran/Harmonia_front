            ...
            <div key={label} className="flex items-center gap-3">
              ...
              <div>
                ...
                {href ? (
                  ...
                  <span className={`inline-block px-2 py-1 rounded-full text-xs font-medium ${value === 'Ativo' || value === 'Em tratamento' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'
                    }`}>{value}</span>
                ) : (
...
const Header = ({ onBack, title }) => (
  <div className="flex items-center gap-4 ">
    <Button 
      variant="secondary" 
      onClick={onBack} 
      className="flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white border border-green-600" 
    >
      <ArrowLeft size={20} />
      Voltar
    </Button>
