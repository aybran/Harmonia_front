      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <button
            ...
            className="flex items-center gap-2 bg-green-600 text-white hover:bg-green-500 hover:scale-105 active:scale-95 px-4 py-2 rounded-lg font-medium transition-all duration-200 shadow-sm hover:shadow-md group"
          >
            <ArrowLeft
              size={20}
          ...
          <h1 className="text-3xl font-bold text-green-600">Detalhes da Sessão</h1>
        </div>
